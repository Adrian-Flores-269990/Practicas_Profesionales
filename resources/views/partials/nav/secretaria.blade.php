    ...
    <ul class="nav" style="width: 100%; justify-content: space-around; display: flex;">
      ...
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu" aria-labelledby="practicasDropdown">
          <li><a class="dropdown-item" href="{{ route('secretaria.constancias') }}">Generar Constancias de Validación</a></li>
          <li><a class="dropdown-item" href="{{ route('secretaria.constancias.historial') }}">Consultar Constancias Generadas</a></li>
        </ul>
      </li>
