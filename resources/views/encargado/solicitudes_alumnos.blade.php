...
<div class="container-fluid my-0 p-0">
  ...
  <div class="p-4">
    ...
    @forelse ($solicitudes as $solicitud)
      <div class="solicitud-card" data-estado="{{ 
        $solicitud->Autorizacion === 1 ? 'aprobada' : 
        ($solicitud->Autorizacion === 0 ? 'rechazada' : 'pendiente') 
      }}">
...
<script>
  ...
  // Filtro por carrera
  document.getElementById('filterCarrera')?.addEventListener('change', function(e) {
