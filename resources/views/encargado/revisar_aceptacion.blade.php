...
@section('title', 'Revisión de Carta de Aceptación')
...
<div class="container-fluid my-0 p-0">
  <h4 class="text-center fw-bold text-white py-3" style="background-color: #000066;">
    REVISAR CARTA DE ACEPTACIÓN (ENCARGADO)
  </h4>

  <div class="container py-4">

    <form action="{{ route('encargado.calificarCartaAceptacion') }}" method="POST" id="form-revision">
      @csrf
      ...
      <div class="mt-4 text-center d-flex gap-3 justify-content-center">
        ...
        <a href="{{ route('encargado.cartasAceptacion') }}" class="btn-regresar">
