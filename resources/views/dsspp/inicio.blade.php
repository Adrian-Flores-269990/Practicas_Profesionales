        ...
        <div class="card-body d-flex align-items-center gap-3">
          ...
          <div class="flex-grow-1">
            ...
            <div class="kv">
              ...
              <div class="kv-value">{{ $dsspp[0]['rpe'] ?? '-' }}</div>
            </div>

            <div class="kv">
              <div class="kv-label">Correo electrónico</div>
              <div class="kv-value">{{ $dsspp[0]['correo_electronico'] ?? '-' }}</div>
            </div>

            <div class="kv">
              <div class="kv-label">Teléfono</div>
              <div class="kv-value">{{ $dsspp[0]['telefono'] ?? '-' }}</div>
            </div>
          </div>
      ...
      <div class="card status-card mb-3">
        <div class="card-body status-grid">
          ...
          <div class="kv kv-status">
            ...
            <div class="kv-value">{{ $dsspp[0]['cargo'] ?? '-' }}</div>
          </div>

          <div class="kv kv-status">
            <div class="kv-label">Rol</div>
            <div class="kv-value">Departamento de Servicio Social y Prácticas Profesionales</div>
          </div>
