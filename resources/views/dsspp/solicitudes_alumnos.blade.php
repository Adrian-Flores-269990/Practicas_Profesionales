...
<div class="container-fluid my-0 p-0">
  ...
  <div class="p-4">
    ...
    @forelse ($solicitudes->reverse() as $solicitud)
      @php
        $autorizacionDsspp = $solicitud->autorizaciones->first();
        $estado = $autorizacionDsspp ? $autorizacionDsspp->Autorizacion : null;
      @endphp

      <div class="solicitud-card"
        data-estado="{{ ($estado === 1 || $estado === 2) ? 'aprobada' : ($estado === 0 ? 'rechazada' : 'pendiente') }}"
