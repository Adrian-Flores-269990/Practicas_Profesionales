  ...
  <div class="contenido" style="font-weight: bold; margin-left: 20px; margin-right: 20px">
      <div class="datosAlumno">
        ...
        <div class="columnaDatos derechaDatos">
          <div>{{ $alumno['Nombre'] }} {{ $alumno['ApellidoP_Alumno'] }} {{ $alumno['ApellidoM_Alumno'] }}</div>
          <div>{{ $alumno['Clave_Alumno'] }}</div>
      ...
      <div class="datosInstitucion">
        ...
        acuerdo con la Jefatura del Área de {{ $area['Area'] }} y la coordinación 
        de la carrera {{ $alumno['Carrera'] }}.</div>
        ...
        <div style="text-align: left; font-weight: normal; font-size: 11px">c.c.p 'Area de {{ $area['Area'] }}'</div>
