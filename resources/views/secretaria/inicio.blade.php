...
<div class="container-xxl secretaria-home my-3">
  <div class="row g-3">
        ...
        <div class="card-body d-flex align-items-center gap-3">
          ...
          <div class="flex-grow-1">
            ...
            <div class="kv">
              ...
              <div class="kv-value">{{ $secretaria['rpe'] ?? '-' }}</div>
            </div>

            <div class="kv">
              <div class="kv-label">rol</div>
              <div class="kv-value">{{ $secretaria['rol'] ?? '-' }}</div>
            </div>
          </div>
        </div>
        ...
        <div class="card-body pt-0">
          <div class="kv-grid">
            ...
            <div class="kv">
              ...
              <div class="kv-value">{{ $secretaria['dependencia'] ?? '-' }}</div>
            </div>
